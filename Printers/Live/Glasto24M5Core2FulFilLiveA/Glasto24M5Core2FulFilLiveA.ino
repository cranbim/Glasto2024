...
void printFulfilment(int messageIndex){
  ...
  if(messageIndex==0){
    ...
    int messageLen=sizeof(messageA3)/messageMaxLength;
    for(int i=0; i<messageLen; i++){
      printer.println(messageA3[i]);
    }
  } else if(messageIndex==4){
    int messageLen=sizeof(messageA4)/messageMaxLength;
    for(int i=0; i<messageLen; i++){
      printer.println(messageA4[i]);
    }
  } else if(messageIndex==5){
    int messageLen=sizeof(messageA5)/messageMaxLength;
    for(int i=0; i<messageLen; i++){
      printer.println(messageA5[i]);
    }
  } else if(messageIndex==6){
    int messageLen=sizeof(messageA6)/messageMaxLength;
    for(int i=0; i<messageLen; i++){
      printer.println(messageA6[i]);
    }
  } else if(messageIndex==7){
    int messageLen=sizeof(messageA7)/messageMaxLength;
    for(int i=0; i<messageLen; i++){
      printer.println(messageA7[i]);
    }
  } else if(messageIndex==8){
    int messageLen=sizeof(messageA8)/messageMaxLength;
    for(int i=0; i<messageLen; i++){
      printer.println(messageA8[i]);
    }
  } else if(messageIndex==9){
    int messageLen=sizeof(messageA9)/messageMaxLength;
    for(int i=0; i<messageLen; i++){
      printer.println(messageA9[i]);
    }
  }
...
void logFulmilment(int fNumber){
  appendFile(SD, "/fulfillivea.txt", "fulfilled", fNumber);
}
